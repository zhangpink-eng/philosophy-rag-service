...
import {
  Settings, MessageCircle, Users, FileText, ChevronLeft,
  MoreVertical, Send, Mic, Volume2, Hand, Clock, Sparkles,
  AlertTriangle, BookOpen, TrendingUp, Search, Plus, Check,
  X, Menu, Home, ArrowLeft, TrendingDown, Eye, Quote,
  User, Users as UsersIcon, Mic2, VolumeX, Pause, Play,
  SkipForward, Clock3, AlertCircle, Lightbulb, MessageSquare,
  BarChart3, Timeline, Target, Zap, ChevronRight
} from 'lucide-react';
...
export const SupervisionPage: React.FC<SupervisionPageProps> = ({
  messages, inputValue, onInputChange, onSend, caseInfo
}) => {
...
export const WorkshopPage: React.FC<WorkshopPageProps> = ({
  messages, inputValue, onInputChange, onSend, onRaiseHand,
  topic, participants, speakingQueue, viewpointMap, currentPhase
}) => {
  const messagesEndRef = useRef<HTMLDivElement>(null);
